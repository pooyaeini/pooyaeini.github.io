...
The scene connects the original particle heart relief to arterial and venous tubes built from the same illuminated spherical particle material. The two large vessel roots begin behind the heart and are hidden by its depth until they curve around its sides. Red arterial highlights travel away from the heart; blue venous highlights travel toward it. The heart uses an asymmetric 72-bpm contraction and smaller rebound pulse while the vessel roots remain anchored. Heart and vessels share radial shading, depth lighting, and color variation. Scroll position moves and banks the camera through progressively finer branches; pointer position controls a subtle orbit. Desktop content reserves a right-hand visual column; smaller screens use opaque text panels over the scene. Persistent chapter links and a pause button control the journey. This is an artistic vascular network, not a diagnostic anatomical model. Rendering targets 30 fps at rest and 60 fps during camera movement, pauses in hidden tabs, and caps pixel density at 1.5. Phones use fewer particles. Reduced-motion preferences and unavailable WebGL use the original static heart artwork. Content remains usable without JavaScript.
